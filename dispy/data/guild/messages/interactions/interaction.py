...
class Interaction(BaseModel):
    ...
    member: GuildMember | None = attrs.field(default=None, converter=GuildMember.from_dict)
    user: User | None = attrs.field(default=None, converter=User.from_dict)
    interaction_token: str = attrs.field(default=None, alias="token")
    version: int = attrs.field(default=-1, converter=int)
    message: Message = attrs.field(default=None, converter=Message.from_dict)
