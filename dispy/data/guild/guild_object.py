...
class Guild(BaseModel):
    ...
    owner_id: Snowflake = attrs.field(converter=int)
    verification_level: int = attrs.field(converter=int)
    explicit_content_filter: int = attrs.field(converter=int)
    default_message_notifications: int = attrs.field(converter=int)
    mfa_level: int = attrs.field(converter=int)
